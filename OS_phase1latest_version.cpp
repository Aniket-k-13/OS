...
void INIT()
{
    ...
    cout << "[INIT] Time counter reset to 0. Time limit = " << TIME_LIMIT << "\n";
...
void START_EXECUTION(ifstream &infile, ofstream &outfile)
{
    ...
    cout << "[TIME] Starting time = " << timeUsed << " / " << TIME_LIMIT << "\n";
    IC = 0;
    ...
    while (true)
    {
        ...
        {
            cerr << "[ERROR] Time Limit Exceeded! Job terminated. Total time used: "
                 << timeUsed << " / " << TIME_LIMIT << "\n";
        ...
        else if (op1 == 'H')
        {
            ...
            cout << "[CPU] H -> Halt. Job complete."
                 << " | Time: " << timeUsed << " / " << TIME_LIMIT << "\n";
            cout << "[TIME] Total time used by this job: " << timeUsed << " / " << TIME_LIMIT << "\n";
            SI = 3;
            MOS(infile, outfile);
            break;
        }
